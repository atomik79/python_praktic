...
def get_dict(n):
    dict_2 = {}
    dict_2.update({3: 12, 4: 13, 5: 1423, 6: 1524, 7: 162534, 8: 172635, 9: 18273645})
    dict_2.update({10: 1923283746, 11: 11029384756, 12: 12131511124210394857, 13: 112211310495867})
    ...
    dict_2.update({20: 1192183731746416515614713812911})
    dict_1 = dict_2.get(n)
    return dict_1
